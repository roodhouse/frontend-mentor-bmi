...
function Tips() {
  return (
    <>
      <div id="tipsContainer" className='pl-[20px] pr-[29px] py-[56px] md:py-[60px] md:pl-[39px] md:pr-[43px]'>

        <div id="healthyWrapper" className='mb-10 md:flex md:items-center'>
          <div id="healthyIcon" className='mb-8 md:w-[64px] md:h-[64px] md:mr-10 md:mb-0'>
            <img src={HealthyIcon} alt="Eating" />
          </div>
          <div id="healthyCopyContainer" className='md:w-[582px]'>
        ...
        <div id="exerciseWrapper" className='mb-10 md:flex md:items-center'>
          <div id="exerciseIcon" className='mb-8 md:w-[64px] md:h-[64px] md:mr-10 md:mb-0'>
            <img src={ExerciseIcon} alt="Exercise" />
          </div>
          <div id="exerciseCopyContainer" className='md:w-[582px]'>
        ...
        <div id="sleepWrapper" className='md:flex md:items-center'>
          <div id="sleepIcon" className='mb-8 md:w-[64px] md:h-[64px] md:mr-10 md:mb-0'>
            <img src={SleepIcon} alt="Sleep" />
          </div>
          <div id="sleepCopyContainer" className='md:w-[582px]'>
