    ...
    <>
        <div id='weigthMetric' className='mb-4'>
                  <div id="weightMetricInputWrapper" className='flex flex-wrap'>
                    ...
                    <div id="weightMetricInput" className='flex rounded-xl border border-solid border-borders w-full px-6 py-[20px] justify-between'>
                      <div id="weightInput" className='w-[75%]'>
                        <input type="text" id='userMetricWeight' name='userMetricWeight' placeholder='0' className='font-["Inter"] text-2xl font-semibold tracking-[-1.2px] text-gunMetal w-full'/>
                      </div>
