    ...
    <>
        <div id='weigthMetric' className='mb-4 md:w-[50%] md:mb-0'>
                  <div id="weightMetricInputWrapper" className='flex flex-wrap'>
                    ...
                    <div id="weightMetricInput" className='flex rounded-xl border border-solid border-borders hover:border-blue cursor-pointer w-full pr-6 pl-[20px] py-[20px] justify-between'>
