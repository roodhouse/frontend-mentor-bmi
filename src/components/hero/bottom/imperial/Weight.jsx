    ...
    <>
              <div id='weightImperial' className='mb-4'>
                  ...
                  <div id="weightInputsContainer" className='flex justify-start'>
                      <div id="weightImperialInputPoundWrapper" className='flex rounded-xl border border-solid border-borders w-[131px] mr-4 pr-6 pl-[20px] py-[20px] justify-between'>
                      ...
                      <div id="weightImperialInputOunceWrapper" className='flex rounded-xl border border-solid border-borders w-[131px] pr-6 pl-[20px] py-[20px] justify-between'>
